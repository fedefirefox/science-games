...
The cat-face bob images and real cat meow sound are included in the download, so the game still works offline.
...
- `assets/audio/` - bundled cat meow audio used by the miao mode
